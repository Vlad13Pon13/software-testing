...
public class SoapApiHelper extends HelperBase{
    ...
    public SoapApiHelper(ApplicationManager applicationManager) {
        super(applicationManager);
        try {
            mantis = new MantisConnectLocator().getMantisConnectPort(
                    new URL(applicationManager.property("soap.endPoint")));
    ...
    public void createIssue(IssueData issueData) {
        ...
        try {
            var categories = mantis.mc_project_get_categories(
                    applicationManager.property("web.username"),
                    applicationManager.property("web.password"),
